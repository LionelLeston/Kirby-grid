...
Model coefficients for the best *N*-mixture model predicting abundance of Alder Flycatcher *Empidonax alnorum* from LIDAR-based data at the 150-m scale (AIC= `r AIC.ALFL.150`) (A), and 500-m scale (AIC= `r AIC.ALFL.500`) (C), along with predicted abundances of this species in the Kirby grid from these respective models (B,D).

![](/Users/llest/OneDrive/Documents/BERA Mentoring/Kirby April 2020/Lidar analyses/3_outputs/figures/PNGplot_ALFL.png)

Model coefficients for the best *N*-mixture model predicting abundance of American Robin *Turdus migratorius* from LIDAR-based data at the 150-m scale (AIC= `r AIC.AMRO.150`) (A), and 500-m scale (AIC= `r AIC.AMRO.500`) (C), along with predicted abundances of this species in the Kirby grid from these respective models (B,D).

![](/Users/llest/OneDrive/Documents/BERA Mentoring/Kirby April 2020/Lidar analyses/3_outputs/figures/PNGplot_AMRO.png)

Model coefficients for the best *N*-mixture model predicting abundance of Boreal Chickadee *Poecile hudsonicus* from LIDAR-based data at the 150-m scale (AIC= `r AIC.BOCH.150`) (A), and 500-m scale (AIC= `r AIC.BOCH.500`) (C), along with predicted abundances of this species in the Kirby grid from these respective models (B,D).

![](/Users/llest/OneDrive/Documents/BERA Mentoring/Kirby April 2020/Lidar analyses/3_outputs/figures/PNGplot_BOCH.png)

Model coefficients for the best *N*-mixture model predicting abundance of Cedar Waxwing *Bombycilla cedrorum* from LIDAR-based data at the 150-m scale (AIC= `r AIC.CEDW.150`) (A), and 500-m scale (AIC= `r AIC.CEDW.500`) (C), along with predicted abundances of this species in the Kirby grid from these respective models (B,D).

![](/Users/llest/OneDrive/Documents/BERA Mentoring/Kirby April 2020/Lidar analyses/3_outputs/figures/PNGplot_CEDW.png)

Model coefficients for the best *N*-mixture model predicting abundance of Chipping Sparrow *Spizella passerina* from LIDAR-based data at the 150-m scale (AIC= `r AIC.CHSP.150`) (A), and 500-m scale (AIC= `r AIC.CHSP.500`) (C), along with predicted abundances of this species in the Kirby grid from these respective models (B,D).

![](/Users/llest/OneDrive/Documents/BERA Mentoring/Kirby April 2020/Lidar analyses/3_outputs/figures/PNGplot_CHSP.png)


Model coefficients for the best *N*-mixture model predicting abundance of Common Yellowthroat *Geothlypis trichas* from LIDAR-based data at the 150-m scale (AIC= `r AIC.COYE.150`) (A), and 500-m scale (AIC= `r AIC.COYE.500`) (C), along with predicted abundances of this species in the Kirby grid from these respective models (B,D).

![](/Users/llest/OneDrive/Documents/BERA Mentoring/Kirby April 2020/Lidar analyses/3_outputs/figures/PNGplot_COYE.png)


Model coefficients for the best *N*-mixture model predicting abundance of Dark-eyed Junco *Junco hyemalis* from LIDAR-based data at the 150-m scale (AIC= `r AIC.DEJU.150`) (A), and 500-m scale (AIC= `r AIC.DEJU.500`) (C), along with predicted abundances of this species in the Kirby grid from these respective models (B,D).

![](/Users/llest/OneDrive/Documents/BERA Mentoring/Kirby April 2020/Lidar analyses/3_outputs/figures/PNGplot_DEJU.png)


Model coefficients for the best *N*-mixture model predicting abundance of Gray Jay *Perisoreus canadensis* from LIDAR-based data at the 150-m scale (AIC= `r AIC.GRAJ.150`) (A), and 500-m scale (AIC= `r AIC.GRAJ.500`) (C), along with predicted abundances of this species in the Kirby grid from these respective models (B,D).

![](/Users/llest/OneDrive/Documents/BERA Mentoring/Kirby April 2020/Lidar analyses/3_outputs/figures/PNGplot_GRAJ.png)


Model coefficients for the best *N*-mixture model predicting abundance of Hermit Thrush *Catharus guttatus* from LIDAR-based data at the 150-m scale (AIC= `r AIC.HETH.150`) (A), and 500-m scale (AIC= `r AIC.HETH.500`) (C), along with predicted abundances of this species in the Kirby grid from these respective models (B,D).

![](/Users/llest/OneDrive/Documents/BERA Mentoring/Kirby April 2020/Lidar analyses/3_outputs/figures/PNGplot_HETH.png)


Model coefficients for the best *N*-mixture model predicting abundance of Le Conte's Sparrow *Ammodramus lecontei* from LIDAR-based data at the 150-m scale (AIC= `r AIC.LCSP.150`) (A), and 500-m scale (AIC= `r AIC.LCSP.500`) (C), along with predicted abundances of this species in the Kirby grid from these respective models (B,D).

![](/Users/llest/OneDrive/Documents/BERA Mentoring/Kirby April 2020/Lidar analyses/3_outputs/figures/PNGplot_LCSP.png)


Model coefficients for the best *N*-mixture model predicting abundance of Lincoln's Sparrow *Melospiza lincolnii* from LIDAR-based data at the 150-m scale (AIC= `r AIC.LISP.150`) (A), and 500-m scale (AIC= `r AIC.LISP.500`) (C), along with predicted abundances of this species in the Kirby grid from these respective models (B,D).

![](/Users/llest/OneDrive/Documents/BERA Mentoring/Kirby April 2020/Lidar analyses/3_outputs/figures/PNGplot_LISP.png)


Model coefficients for the best *N*-mixture model predicting abundance of Olive-sided Flycatcher *Contopus cooperi* from LIDAR-based data at the 150-m scale (AIC= `r AIC.OSFL.150`) (A), and 500-m scale (AIC= `r AIC.OSFL.500`) (C), along with predicted abundances of this species in the Kirby grid from these respective models (B,D).

![](/Users/llest/OneDrive/Documents/BERA Mentoring/Kirby April 2020/Lidar analyses/3_outputs/figures/PNGplot_OSFL.png)


Model coefficients for the best *N*-mixture model predicting abundance of Ovenbird *Seiurus aurocapillus* from LIDAR-based data at the 150-m scale (AIC= `r AIC.OVEN.150`) (A), and 500-m scale (AIC= `r AIC.OVEN.500`) (C), along with predicted abundances of this species in the Kirby grid from these respective models (B,D).

![](/Users/llest/OneDrive/Documents/BERA Mentoring/Kirby April 2020/Lidar analyses/3_outputs/figures/PNGplot_OVEN.png)


Model coefficients for the best *N*-mixture model predicting abundance of Palm Warbler *Setophaga palmarum* from LIDAR-based data at the 150-m scale (AIC= `r AIC.PAWA.150`) (A), and 500-m scale (AIC= `r AIC.PAWA.500`) (C), along with predicted abundances of this species in the Kirby grid from these respective models (B,D).

![](/Users/llest/OneDrive/Documents/BERA Mentoring/Kirby April 2020/Lidar analyses/3_outputs/figures/PNGplot_PAWA.png)


Model coefficients for the best *N*-mixture model predicting abundance of Red-eyed Vireo *Vireo olivaceus* from LIDAR-based data at the 150-m scale (AIC= `r AIC.REVI.150`) (A), and 500-m scale (AIC= `r AIC.REVI.500`) (C), along with predicted abundances of this species in the Kirby grid from these respective models (B,D).

![](/Users/llest/OneDrive/Documents/BERA Mentoring/Kirby April 2020/Lidar analyses/3_outputs/figures/PNGplot_REVI.png)


Model coefficients for the best *N*-mixture model predicting abundance of Ruby-crowned Kinglet *Regulus calendula* from LIDAR-based data at the 150-m scale (AIC= `r AIC.RCKI.150`) (A), and 500-m scale (AIC= `r AIC.RCKI.500`) (C), along with predicted abundances of this species in the Kirby grid from these respective models (B,D).

![](/Users/llest/OneDrive/Documents/BERA Mentoring/Kirby April 2020/Lidar analyses/3_outputs/figures/PNGplot_RCKI.png)


Model coefficients for the best *N*-mixture model predicting abundance of Swainson's Thrush *Catharus ustulatus* from LIDAR-based data at the 150-m scale (AIC= `r AIC.SWTH.150`) (A), and 500-m scale (AIC= `r AIC.SWTH.500`) (C), along with predicted abundances of this species in the Kirby grid from these respective models (B,D).

![](/Users/llest/OneDrive/Documents/BERA Mentoring/Kirby April 2020/Lidar analyses/3_outputs/figures/PNGplot_SWTH.png)


Model coefficients for the best *N*-mixture model predicting abundance of Swamp Sparrow *Melospiza georgiana* from LIDAR-based data at the 150-m scale (AIC= `r AIC.SWSP.150`) (A), 500-m scale (AIC= `r AIC.SWSP.500`) (C), along with predicted abundances of this species in the Kirby grid from these respective models (B,D).

![](/Users/llest/OneDrive/Documents/BERA Mentoring/Kirby April 2020/Lidar analyses/3_outputs/figures/PNGplot_SWSP.png)


Model coefficients for the best *N*-mixture model predicting abundance of Tennessee Warbler *Leiothlypis peregrina* from LIDAR-based data at the 150-m scale (AIC= `r AIC.TEWA.150`) (A), and 500-m scale (AIC= `r AIC.TEWA.500`) (C), along with predicted abundances of this species in the Kirby grid from these respective models (B,D).

![](/Users/llest/OneDrive/Documents/BERA Mentoring/Kirby April 2020/Lidar analyses/3_outputs/figures/PNGplot_TEWA.png)


Model coefficients for the best *N*-mixture model predicting abundance of Winter Wren *Troglodytes hiemalis* from LIDAR-based data at the 150-m scale (AIC= `r AIC.WIWR.150`) (A), and 500-m scale (AIC= `r AIC.WIWR.500`) (C), along with predicted abundances of this species in the Kirby grid from these respective models (B,D).

![](/Users/llest/OneDrive/Documents/BERA Mentoring/Kirby April 2020/Lidar analyses/3_outputs/figures/PNGplot_WIWR.png)


Model coefficients for the best *N*-mixture model predicting abundance of White-throated Sparrow *Zonotrichia albicollis* from LIDAR-based data at the 150-m scale (AIC= `r AIC.WTSP.150`) (A), and 500-m scale (AIC= `r AIC.WTSP.500`) (C), along with predicted abundances of this species in the Kirby grid from these respective models (B,D).

![](/Users/llest/OneDrive/Documents/BERA Mentoring/Kirby April 2020/Lidar analyses/3_outputs/figures/PNGplot_WTSP.png)


Model coefficients for the best *N*-mixture model predicting abundance of Yellow-rumped Warbler *Setophaga coronata* from LIDAR-based data at the 150-m scale (AIC= `r AIC.YRWA.150`) (A), and 500-m scale (AIC= `r AIC.YRWA.500`) (C), along with predicted abundances of this species in the Kirby grid from these respective models (B,D).

![](/Users/llest/OneDrive/Documents/BERA Mentoring/Kirby April 2020/Lidar analyses/3_outputs/figures/PNGplot_YRWA.png)
