...
#2. site covariates
site_beaudoin_cov<-read.csv("0_data/processed/Kirby.Beaudoin.3spatscale.csv",header=TRUE)
write.csv(site_beaudoin_cov, file="0_data/processed/unmarked/site_beaudoin_cov.csv")

site.covs.wo.SS<-site_beaudoin_cov
site.covs.wo.SS$SS<-NULL
site.covs.wo.SS$NORTHING<-NULL
site.covs.wo.SS$EASTING<-NULL
site.covs.wo.SS$optional<-NULL
site.covs.wo.SS$X<-NULL
site.covs.wo.SS$ID<-NULL
...
sitecov<-read.csv("0_data/processed/unmarked/site_beaudoin_cov.csv",header=TRUE)
sitecov<-sitecov[,-1]
